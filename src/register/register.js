...
function Register() {
    ...
    const handleSubmit = async () => {
        try {
            const response = await createsede(username, email, password, address, contact, manager);
                ...
                <div className="form-container">
                    ...
                    <div className="form">
                        <div className="form-group">
                            <div className="row">
                                <div className="col">
                                    <label htmlFor="sede" className="form-label">Nombre de la sede</label>
                                    <input
                                        type="text"
                                ...
                                <div className="col">
                                    <label htmlFor="encargado" className="form-label">Nombre del encargado</label>
                                    <input
                                        type="text"
                                        className="form-control"
                                        id="encargado"
                            ...
                            <div className="row">
                                ...
                                <div className="col">
                                    ...
                                    <div className="input-with-icon">
                                        ...
                                        />
                                        <button type="button" className="toggle-password" onClick={toggleMostrarContrasena}>
